<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserModule.aspx.cs" Inherits="NovelReader2.UserModule" %>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" Width="1000px"> 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Rating">
                        <ItemTemplate>
                            <asp:Label ID="lbl_Rating" runat="server" Text='<%# Eval("Rating") %>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
