<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenreMecha.aspx.cs" Inherits="NovelReader2.MenuItemsUser.Genre.GenreMecha" %>
        ...
        <div>
           <h1>Novel Reader</h1><br />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Image], [Name], [Genre], [ContentType], [Rating], [DateTime] FROM [Novels] WHERE ([Genre] = @Genre)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="Mecha" Name="Genre" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
