<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenreSci-Fi.aspx.cs" Inherits="NovelReader2.MenuItemsUser.Genre.GenreSci_Fi" %>
        ...
        <div>
           <h1>Novel Reader</h1><br />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Image], [Name], [Genre], [ContentType], [Rating], [DateTime] FROM [Novels] WHERE ([Genre] = @Genre)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="Sci-Fiction" Name="Genre" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
